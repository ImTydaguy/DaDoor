...
// Password
char Master[Password_Length] = "123456"; // password
...
char knownTags[kTags][idLen] = {
             "AAAAAAAAAAAA", // List of authorized cards, upload code to arduino, 
             "444444444444", // scan, then look in serial monitor, it will tell you your card number
             "555555555555",
             "7A005B0FF8D6"
};
